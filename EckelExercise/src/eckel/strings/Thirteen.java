...
/*
 * ex 13
 * modify StartEnd.java so that it uses Groups.POEM as input, bu still produces positive outputs 
 * for find(),lookingAt() and matches().
 */
...
public class Thirteen {
	...
	for (String in : StartEnd.input.split("\n")) {
	    ...
	    for (String regex : new String[] { "\\w*are\\w*", "A\\w*",
		    "T\\w+", "Did." })
